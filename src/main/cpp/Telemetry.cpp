...
void Telemetry::subsystemTelemeterize(ClawState const &clawState,
  ...
  SignalLogger::WriteDouble("ElevatorState/MasterPose",
                            elevatorState.masterPose);
  SignalLogger::WriteDouble("ElevatorState/SlavePose", elevatorState.slavePose);
  SignalLogger::WriteDouble("ElevatorState/ElevatorPose",
                            elevatorState.elevatorPose);
  ...
  SignalLogger::WriteBoolean("ClawState/ClawAcceptableAngle",
                             clawState.acceptableAngle);
};
